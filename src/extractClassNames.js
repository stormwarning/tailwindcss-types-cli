...
async function process(groups) {
    ...
    groups.forEach((group) => {
        group.root.walkRules((rule) => {
            classNames.push(getClassNamesFromSelector(rule.selector))
    ...
    return { classNames: classNames.reduce((a, b) => a.concat(b), []) }
}
